    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col justify-between bg-[#5BC5A7] text-white p-10">
        ...
        <div className="max-w-md">
          <h1 className="text-4xl font-semibold leading-tight">Split expenses with friends without the awkwardness</h1>
          <p className="mt-4 text-white/90">Track balances, settle up, and keep everyone on the same page.</p>
        </div>
